...
sparse_rewards=${sparse_rewards:-False}

rollout_name="vllm"
project_name='grpo_manufactoria_has'
exp_name="qwen3_4b_megatron_full_ft_bs${TRAIN_BATCH_SIZE}_maxlen${MAX_RESPONSE_LENGTH}_ep${NUM_EPOCHS}_sparse${sparse_rewards}"
adv_estimator=grpo
