...
from ...experimental.dataset.sampler import AbstractCurriculumSampler
from ...protocol import pad_dataproto_to_divisor, unpad_dataproto
from ...single_controller.ray import RayClassWithInitArgs, RayResourcePool, RayWorkerGroup
from ...single_controller.ray.base import create_colocated_worker_cls
from ...trainer.config import AlgoConfig
from ...trainer.ppo import core_algos
from ...trainer.ppo.core_algos import AdvantageEstimator, agg_loss
from ...trainer.ppo.metric_utils import (
...
from ...trainer.ppo.reward import compute_reward, compute_reward_async
from ...trainer.ppo.utils import Role, WorkerType, need_critic, need_reference_policy, need_reward_model
from ...utils import tensordict_utils as tu
from ...utils.checkpoint.checkpoint_manager import find_latest_ckpt_path, should_save_ckpt_esi
from ...utils.config import omega_conf_to_dataclass
from ...utils.debug import marked_timer
from ...utils.import_utils import load_class_from_fqn
from ...utils.model import compute_position_id_with_mask
from ...utils.metric import reduce_metrics
from ...utils.py_functional import rename_dict
from ...utils.rollout_skip import RolloutSkip
from ...utils.seqlen_balancing import calculate_workload, get_seqlen_balanced_partitions, log_seqlen_unbalance
...
from ...workers.config import FSDPEngineConfig
from ...workers.utils.padding import left_right_2_no_padding, no_padding_2_padding
...
class RayPPOTrainer:
    ...
    def _create_dataloader(self, train_dataset, val_dataset, collate_fn, train_sampler: Optional[Sampler]):
        ...
        from ...trainer.main_ppo import create_rl_dataset, create_rl_sampler
        ...
        if collate_fn is None:
            from ...utils.dataset.rl_dataset import collate_fn as default_collate_fn
    ...
    def init_workers(self):
        ...
        if self.use_critic:
            ...
            from ...workers.config import CriticConfig

            critic_cfg: CriticConfig = omega_conf_to_dataclass(self.config.critic)

            if self.use_legacy_worker_impl == "disable":
                # convert critic_cfg into TrainingWorkerConfig
                from ...workers.engine_workers import TrainingWorkerConfig
        ...
        if not self.use_reward_loop:
            ...
            if not can_reward_loop_parallelize:
                from ...experimental.reward_loop import RewardLoopManager
        ...
        if self.use_critic:
            ...
            if self.use_legacy_worker_impl == "disable":
                ...
                from ...workers.utils.losses import value_loss
        ...
        if manager_class_fqn:
            ...
            from ...experimental.agent_loop import AgentLoopManager
    ...
    def _save_checkpoint(self):
        from ...utils.fs import local_mkdir_safe
    ...
    def _balance_batch(self, batch: DataProto, metrics, logging_prefix="global_seqlen", keep_minibatch=False):
        ...
        if getattr(self, "use_prefix_grouper", False) and "uid" in batch.non_tensor_batch:
            from ...utils.seqlen_balancing import get_group_balanced_partitions
            ...
            for batch_dict in self.train_dataloader:
                ...
                with marked_timer("step", timing_raw):
                    ...
                    if bypass_recomputing_logprobs:  # Use `rollout_log_probs`
                        from ...trainer.ppo.rollout_corr_helper import apply_bypass_mode
                        ...
                        with marked_timer("old_log_prob", timing_raw, color="blue"):
                            ...
                            if "rollout_log_probs" in batch.batch.keys():
                                ...
                                from ...utils.debug.metrics import calculate_debug_metrics
                    ...
                    with marked_timer("adv", timing_raw, color="brown"):
                        ...
                        if (
                            ...
                            from ...trainer.ppo.rollout_corr_helper import compute_rollout_correction_and_add_to_batch
