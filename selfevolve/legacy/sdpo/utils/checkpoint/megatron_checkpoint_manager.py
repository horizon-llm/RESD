...
from ...models.weight_loader_registry import get_weight_saver
from ...utils.device import get_device_name, get_torch_device
from ...utils.fs import is_non_local, local_mkdir_safe
from ...utils.logger import log_with_rank
from ...utils.megatron.dist_checkpointing import load_dist_checkpointing, save_dist_checkpointing
    ...
    def load_checkpoint(self, local_path: str, hdfs_path: str = None, del_local_after_load=False):
        ...
        if self.should_load_model and self.peft_cls is not None:
            ...
            if os.path.exists(adapter_ckpt_path):
                from ...utils.megatron_peft_utils import load_adapter_checkpoint
    ...
    def save_checkpoint(self, local_path: str, hdfs_path: str = None, global_step: int = 0, max_ckpt_to_keep=None):
        ...
        if self.should_save_model:
            ...
            if self.peft_cls is not None:
                from ...utils.megatron_peft_utils import save_adapter_checkpoint
