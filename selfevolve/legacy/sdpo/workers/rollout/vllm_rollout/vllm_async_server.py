...
from ....utils.vllm.vllm_fp8_utils import apply_vllm_fp8_patches
from ....workers.config import HFModelConfig, RolloutConfig
from ....workers.rollout.replica import RolloutMode, RolloutReplica, TokenOutput
from ....workers.rollout.utils import (
    get_free_port,
    get_max_position_embeddings,
    is_valid_ipv6_address,
    run_unvicorn,
)
from ....workers.rollout.vllm_rollout import vLLMAsyncRollout
...
class vLLMHttpServer:
    ...
    async def launch_server(self, master_address: str = None, master_port: int = None):
        ...
        if not self.config.enable_sleep_mode:
            from ....utils.device import set_expandable_segments
