...
from ...trainer.ppo.ray_trainer import RayResourcePool, ResourcePoolManager
...
def _load_vllm():
    from ...workers.rollout.vllm_rollout.vllm_async_server import vLLMReplica
...
def _load_sglang():
    ...
    from ...workers.rollout.sglang_rollout.async_sglang_server import SGLangReplica
