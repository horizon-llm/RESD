...
try:
    from ..workers.engine.mindspeed.transformer_impl import repatch
except ImportError:
    repatch = None
...
from ..models.mcore import get_mcore_weight_converter
...
from ..utils.checkpoint.megatron_checkpoint_manager import MegatronCheckpointManager
...
from ..utils.distributed import set_numa_affinity
from ..utils.flops_counter import FlopsCounter
from ..utils.fs import copy_to_local
from ..utils.megatron.router_replay_patch import RouterReplay, RouterReplayAction, apply_router_replay_patch
...
from ..utils.memory_utils import aggressive_empty_cache
from ..utils.model import get_hf_model_path, load_mcore_dist_weights, load_megatron_gptmodel_weights
...
from ..utils.profiler.performance import reduce_timing, topk_reduce_ratio_min_max
from ..utils.ray_utils import get_event_loop
from ..utils.torch_functional import use_original_torch_compile
from ..workers.actor.megatron_actor import MegatronPPOActor
from ..workers.config import HFModelConfig, McoreCriticConfig, RolloutConfig
from ..workers.critic.megatron_critic import MegatronPPOCritic
from ..workers.reward_model.megatron.reward_model import MegatronRewardModel
from ..workers.rollout import get_rollout_class
...
class MegatronWorker(Worker):
    def _init_hf_config_and_tf_config(
        ...
        from ..models.mcore import hf_to_mcore_config
        from ..utils import hf_processor, hf_tokenizer
        from ..utils.fs import copy_to_local
        from ..utils.model import update_model_config
        ...
        if megatron_config.use_mbridge:
            if self.vanilla_bridge:
                ...
                from ..models.mcore.bridge import AutoBridge
        ...
        from ..workers.config.megatron_peft import get_peft_cls
...
class ActorRolloutRefWorker(MegatronWorker, DistProfilerExtension):
    ...
    def _build_model_optimizer(
        ...
        from ..utils.megatron_utils import McoreModuleWrapperConfig, make_megatron_module
        from ..utils.model import get_generation_config, print_model_size
    ...
    def update_actor(self, data: DataProto):
        ...
        from ..utils.megatron.optimizer import get_megatron_last_lr
...
class CriticWorker(MegatronWorker, DistProfilerExtension):
    ...
    def _build_critic_model_optimizer(
        ...
        from ..utils.megatron_utils import McoreModuleWrapperConfig, make_megatron_module
        from ..utils.model import print_model_size
