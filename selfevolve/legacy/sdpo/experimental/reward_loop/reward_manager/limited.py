...
from ....experimental.reward_loop.reward_manager import register as register_manager
...
from ....workers.reward_manager import register as register_manager_legacy
