...
from ...experimental.fully_async_policy.fully_async_rollouter import FullyAsyncRollouter
from ...experimental.fully_async_policy.fully_async_trainer import FullyAsyncTrainer
from ...experimental.fully_async_policy.message_queue import MessageQueue, MessageQueueClient
...
def create_role_worker_mapping(config):
    ...
    if config.actor_rollout_ref.actor.strategy in ["fsdp", "fsdp2"]:
        ...
        from ...experimental.fully_async_policy.fsdp_workers import (
            CriticWorker,
            DetachActorWorker,
        ...
        from ...experimental.fully_async_policy.megatron_worker import (
            CriticWorker,
            DetachActorWorker,
            DetachAsyncRolloutWorker,
        )
...
class FullyAsyncTaskRunner:
    ...
    def _initialize_components(self, config) -> None:
        ...
        from ...experimental.fully_async_policy.param_sync import ParameterSynchronizer
