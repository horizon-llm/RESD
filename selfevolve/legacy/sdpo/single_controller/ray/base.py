...
from ...protocol import DataProto, _padding_size_key
from ...single_controller.base import ClassWithInitArgs, ResourcePool, Worker, WorkerGroup
from ...single_controller.base.decorator import MAGIC_ATTR, Dispatch
from ...utils.device import get_device_name
from ...utils.py_functional import temp_env_var
...
class RayWorkerGroup(WorkerGroup):
    ...
    def _create_worker(self, rank, pg_idx, pg, local_rank, resource_pool, ray_cls_with_init, worker_env, detached):
        ...
        # Propagate PYTHONPATH/PYTHONSAFEPATH so workers resolve the correct
        # verl package (actor-level env_vars can clobber job-level ones).
        for _key in ("PYTHONPATH", "PYTHONSAFEPATH"):
