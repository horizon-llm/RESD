...
from ..utils.device import get_device_name, get_nccl_backend, get_torch_device
from ..utils.distributed import set_numa_affinity
from ..utils.megatron.dist_checkpointing import load_dist_checkpointing
from ..utils.megatron_utils import get_model
from ..utils.tokenizer import hf_processor, hf_tokenizer
...
class MegatronModelMerger(BaseModelMerger):
    ...
    def merge_and_save(self):
        from ..utils.megatron_utils import get_dist_checkpoint_path
