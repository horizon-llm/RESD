...
class TrainingFreeGRPODataManager(DBDataManager):
    ...
    def get_batch_samples(
        ...
        exp_id = f"{self.config.exp_id}_{cache_dim}_{epoch}"
        with SQLModelUtils.create_session() as session:
