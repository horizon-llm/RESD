...
class ACEBatch(ACE):
    """
    Batch version of ACE with parallel generation and reflection.
    ...
    - Curation remains sequential (modifies shared playbook)
    ...
    def _train_batch(
        ...
        """
        Process a batch of samples with parallel gen/reflect and sequential curation.
        ...
        4. Sequential curation (modifies shared playbook)
        ...
        # =====================================================================
        # Phase 4: Sequential curation
        # =====================================================================
        print(f"\n--- Phase 4: Sequential Curation ---")
        for i, (sample, ref_result) in enumerate(
            zip(batch_samples, reflect_results)
        ):
            step = batch_steps[i]
            ...
            if step % curator_frequency == 0:
                ...
                t0 = time.perf_counter()
                self.playbook, self.next_global_id, operations, _ = \
                    self.curator.curate(
        ...
        for i in range(len(batch_samples)):
            combined.append({
                ...
                "latency": {
                    ...
                    "curation_time": curation_time if (batch_steps[i] % curator_frequency == 0) else None,
