...
train_path=selfevolve/resd/datasets/bouncingsim_multiobj_basic/train_${NUM_DATA}.parquet
val_path=selfevolve/resd/datasets/bouncingsim_multiobj_basic/test.parquet
