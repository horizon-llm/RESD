...
def run_proprocessing(train_data_source, test_data_source, data_source_suffix, num_proc=4, num_data=-1):
    ...
    out_train = os.path.join("selfevolve/resd/datasets/manufactoria", f"train_{num_data}.parquet")
    out_test  = os.path.join("selfevolve/resd/datasets/manufactoria", "test.parquet")
