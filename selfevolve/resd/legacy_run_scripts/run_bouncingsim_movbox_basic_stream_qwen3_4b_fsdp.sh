...
train_path=selfevolve/resd/datasets/bouncingsim_movbox_basic/train_${NUM_DATA}.parquet
val_path=selfevolve/resd/datasets/bouncingsim_movbox_basic/test.parquet
