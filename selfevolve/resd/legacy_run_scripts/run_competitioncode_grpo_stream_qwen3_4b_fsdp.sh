...
python selfevolve/resd/data/format/competitioncode.py \
...
train_path=selfevolve/resd/datasets/competitioncode_${ALGO_CATEGORY}/train_${NUM_DATA}.parquet
val_path=selfevolve/resd/datasets/competitioncode_${ALGO_CATEGORY}/test.parquet
...
DATA=(
    ...
    custom_reward_function.path=selfevolve/resd/feedback/competitioncode.py
