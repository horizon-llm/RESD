...
python selfevolve/resd/preprocess.py --truncate_parquet selfevolve/sdpo/datasets/knight_swap --num_data $NUM_DATA

train_path=selfevolve/sdpo/datasets/knight_swap/train_${NUM_DATA}.parquet
val_path=selfevolve/sdpo/datasets/knight_swap/test.parquet
...
cu_teacher_prompt_file=${cu_teacher_prompt_file:-"selfevolve/resd/context_updater/prompts/knight_swap_generator_v1.txt"} # path to a .txt file with custom context-updater teacher prompt; null uses built-in default
...
project_name='sdpo_stream_knight_swap'
