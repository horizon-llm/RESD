...
train_path=selfevolve/resd/datasets/bouncingsim_rotbox_basic/train_${NUM_DATA}.parquet
val_path=selfevolve/resd/datasets/bouncingsim_rotbox_basic/test.parquet
