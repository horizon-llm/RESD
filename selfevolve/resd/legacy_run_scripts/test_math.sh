...
#   CHECKPOINT_PATH=checkpoints/sdpo_finer/my_exp/global_step_100 bash selfevolve/resd/test_finer.sh
#
...
#     bash selfevolve/resd/test_finer.sh
# ---------------
...
"$PYTHON" -m selfevolve.resd.trainer.main_ppo \
    ...
    trainer.project_name=sdpo_math \
