...
Usage:
  # Single file
  python selfevolve/resd/aggregate_generations.py path/to/0.jsonl

  # Whole checkpoint directory (picks up all *.jsonl inside)
  python selfevolve/resd/aggregate_generations.py val_generations/kayleexl_models_livecodebench/

  # Glob across all checkpoints, print a summary table
  python selfevolve/resd/aggregate_generations.py val_generations/kayleexl_models_livecodebench/*/val_generations/0.jsonl
"""
