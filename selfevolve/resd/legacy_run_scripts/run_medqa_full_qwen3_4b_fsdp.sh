...
python selfevolve/resd/preprocess.py --truncate_parquet selfevolve/sdpo/datasets/medqa --num_data $NUM_DATA
...
DATA=(
    ...
    custom_reward_function.path=selfevolve/resd/feedback/mcq.py
