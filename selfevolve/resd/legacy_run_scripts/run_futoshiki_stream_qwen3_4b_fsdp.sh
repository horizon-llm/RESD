...
python selfevolve/resd/preprocess.py --truncate_parquet selfevolve/sdpo/datasets/futoshiki --num_data $NUM_DATA

train_path=selfevolve/sdpo/datasets/futoshiki/train_${NUM_DATA}.parquet
val_path=selfevolve/sdpo/datasets/futoshiki/test.parquet
...
cu_teacher_prompt_file=${cu_teacher_prompt_file:-"selfevolve/resd/context_updater/prompts/futoshiki_generator_v1.txt"} # path to a .txt file with custom context-updater teacher prompt; null uses built-in default
...
project_name='sdpo_stream_futoshiki'
