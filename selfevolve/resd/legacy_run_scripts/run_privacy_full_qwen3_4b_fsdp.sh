...
python selfevolve/resd/preprocess.py --truncate_parquet selfevolve/sdpo/datasets/privacy --num_data $NUM_DATA
...
DATA=(
    ...
    custom_reward_function.path=selfevolve/resd/feedback/privacy.py
