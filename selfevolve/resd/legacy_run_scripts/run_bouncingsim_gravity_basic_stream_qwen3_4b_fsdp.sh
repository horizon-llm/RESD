...
train_path=selfevolve/resd/datasets/bouncingsim_gravity_basic/train_${NUM_DATA}.parquet
val_path=selfevolve/resd/datasets/bouncingsim_gravity_basic/test.parquet
