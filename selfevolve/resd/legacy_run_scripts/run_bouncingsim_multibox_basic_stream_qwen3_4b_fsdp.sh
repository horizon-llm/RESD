...
train_path=selfevolve/resd/datasets/bouncingsim_multibox_basic/train_${NUM_DATA}.parquet
val_path=selfevolve/resd/datasets/bouncingsim_multibox_basic/test.parquet
