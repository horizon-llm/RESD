...
train_path=selfevolve/resd/datasets/bouncingsim_rotobj_basic/train_${NUM_DATA}.parquet
val_path=selfevolve/resd/datasets/bouncingsim_rotobj_basic/test.parquet
