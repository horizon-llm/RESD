...
python selfevolve/resd/preprocess.py --truncate_parquet selfevolve/sdpo/datasets/rg_games --num_data $NUM_DATA
...
cu_teacher_prompt_file=${cu_teacher_prompt_file:-"selfevolve/resd/context_updater/prompts/rg_games_generator_v1.txt"} # path to a .txt file with custom context-updater teacher prompt; null uses built-in default
