...
max_bullets=${max_bullets:-200} # maximum number of feedback bullets to include in the context; null means no limit
...
cu_teacher_prompt_file=${cu_teacher_prompt_file:-"selfevolve/resd/context_updater/prompts/manufactoria_generator_v4.txt"} # path to a .txt file with custom context-updater teacher prompt; null uses built-in default
# === stream trainer ===
...
project_name='resd_stream_manufactoria'
