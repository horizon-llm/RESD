...
#   bash selfevolve/resd/test_lcbv6.sh
#
# Test a local checkpoint:
#   CHECKPOINT_PATH=checkpoints/sdpo_lcb_v6/my_exp/global_step_100 bash selfevolve/resd/test_lcbv6.sh
#
...
"$PYTHON" -m selfevolve.resd.trainer.main_ppo \
    ...
    custom_reward_function.path=selfevolve/resd/feedback/code.py \
