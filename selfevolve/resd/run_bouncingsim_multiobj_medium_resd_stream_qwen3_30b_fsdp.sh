...
train_path=selfevolve/resd/datasets/bouncingsim_multiobj_medium/train_${NUM_DATA}.parquet
val_path=selfevolve/resd/datasets/bouncingsim_multiobj_medium/test.parquet
...
max_bullets=${max_bullets:-150} # maximum number of feedback bullets to include in the context; null means no limit
concise_method=${concise_method:-"prioritized"} # method for concising context, choose from "reset", "prioritized", "staleness"
...
cu_teacher_prompt_file=${cu_teacher_prompt_file:-"selfevolve/resd/context_updater/prompts/bouncingsim_generator_v4.txt"} # path to a .txt file with custom context-updater teacher prompt; null uses built-in default
# === stream trainer ===
...
project_name='resd_stream_bouncingsim'
