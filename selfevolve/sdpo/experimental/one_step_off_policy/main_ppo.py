...
from ...experimental.one_step_off_policy.ray_trainer import OneStepOffRayTrainer
...
from ...trainer.ppo.utils import Role, need_reference_policy
from ...utils.config import validate_config
from ...utils.device import auto_set_device
...
def create_role_worker_mapping(config):
    ...
    if config.actor_rollout_ref.actor.strategy in ["fsdp", "fsdp2"]:
        ...
        from ...experimental.one_step_off_policy.fsdp_workers import (
            CriticWorker,
            DetachActorWorker,
        ...
        from ...experimental.one_step_off_policy.megatron_workers import (
            CriticWorker,
            DetachActorWorker,
            DetachAsyncRolloutWorker,
        )
...
def main(config):
    ...
    from ...trainer.main_ppo import run_ppo
