...
from ...experimental.one_step_off_policy.utils import need_critic
from ...single_controller.ray import RayClassWithInitArgs, RayWorkerGroup
from ...single_controller.ray.base import create_colocated_worker_cls
from ...trainer.ppo import core_algos
from ...trainer.ppo.core_algos import agg_loss
from ...trainer.ppo.metric_utils import compute_data_metrics, compute_throughout_metrics, compute_timing_metrics
...
from ...trainer.ppo.utils import Role, WorkerType, need_reference_policy, need_reward_model
from ...utils import omega_conf_to_dataclass
from ...utils.checkpoint.checkpoint_manager import should_save_ckpt_esi
...
class OneStepOffRayTrainer(RayPPOTrainer):
    ...
    def _create_weight_sync_group(self):
        from ...utils.device import get_nccl_backend
    ...
    def _init_async_rollout_manager(self):
        ...
        from ...experimental.one_step_off_policy.agent_loop import OneStepOffAgentLoopManager
