...
from ...utils.device import get_device_id, get_device_name, get_torch_device, set_expandable_segments
...
from ...utils.profiler import DistProfiler, log_gpu_memory_usage, simple_timer
from ...utils.profiler.performance import reduce_timing, topk_reduce_ratio_min_max
from ...workers.config import HFModelConfig
...
class RobActorRolloutRefWorker(ActorRolloutRefWorker):
    ...
    def _build_rollout(self, trust_remote_code=False):
        from ...experimental.vla.naive_rollout_rob import NaiveRolloutRob
    ...
    @register(dispatch_mode=Dispatch.ONE_TO_ALL)
    def init_model(self):
        from ...experimental.vla.dp_rob import RobDataParallelPPOActor
        ...
        from ...experimental.vla.models.openvla_oft.configuration_prismatic import OpenVLAConfig
        from ...experimental.vla.models.openvla_oft.modeling_prismatic import OpenVLAForActionPrediction
        from ...experimental.vla.models.openvla_oft.processing_prismatic import (
