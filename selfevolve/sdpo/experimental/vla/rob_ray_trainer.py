...
from ...trainer.ppo.ray_trainer import RayPPOTrainer, apply_kl_penalty, compute_advantage
from ...trainer.ppo.reward import compute_reward
...
class RobRayPPOTrainer(RayPPOTrainer):
    ...
    def init_workers(self):
        ...
        if self.config.actor_rollout_ref.rollout.mode == "async_envloop":
            from ...experimental.vla.env_loop import EnvLoop
