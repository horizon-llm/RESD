...
from ...utils.transformers_compat import is_transformers_version_in_range
                ...
                if visual_pos_masks is not None:
                    ...
                    if deepstack_visual_embeds is not None:
                        ...
                        if num_visual_in_shard > 0 and num_visual_before > 0:
                            ...
                            from ...utils.ulysses import get_ulysses_sequence_parallel_rank
...
def patch_forward_with_backends(
    ...
    if model.config.model_type in ["qwen2_5_vl", "qwen2_vl"]:
        from ...models.transformers.qwen2_vl import forward_with_torch_backend, forward_with_triton_backend
        ...
        from ...models.transformers.qwen3_vl import forward_with_torch_backend, forward_with_triton_backend

        forward_with_torch_backend_function = forward_with_torch_backend
        forward_with_triton_backend_function = forward_with_triton_backend
    elif model.config.model_type == "glm4v":
        from ...models.transformers.glm4v import forward_with_torch_backend, forward_with_triton_backend

        forward_with_torch_backend_function = forward_with_torch_backend
        forward_with_triton_backend_function = forward_with_triton_backend
    else:
        from ...models.transformers.dense_common import forward_with_torch_backend, forward_with_triton_backend
...
def apply_monkey_patch(
    ...
    if use_tiled_mlp:
        from ...models.transformers.tiled_mlp import apply_tiled_mlp_monkey_patch
    ...
    if model.config.model_type in ["qwen2_5_vl", "qwen2_vl"]:
        ...
        from ...models.transformers.qwen2_vl import forward_with_normal_backend, qwen2_vl_base_forward
        ...
        if use_remove_padding or ulysses_sp_size > 1:
            from ...models.transformers.qwen2_vl import qwen2_vl_attn_forward
        ...
        from ...models.transformers.qwen3_vl import (
        ...
        from ...models.transformers.glm4v import forward_with_normal_backend, glm4v_base_forward
        ...
        # Step 2: patch attention to support ulysses parallelism
        if use_remove_padding or ulysses_sp_size > 1:
            from ...models.transformers.glm4v import glm4v_attn_forward
        ...
        if use_remove_padding or ulysses_sp_size > 1:
            ...
            from ...models.transformers.kimi_vl import _ulysses_flash_attn_forward
