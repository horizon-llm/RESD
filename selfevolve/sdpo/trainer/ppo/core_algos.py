...
from ...utils import as_torch_index, group_mean_std
from ...utils.import_utils import deprecated
...
def compute_policy_loss_bypass_mode(
    ...
    """
    from ...trainer.ppo.rollout_corr_helper import compute_rollout_correction_and_rejection_mask
