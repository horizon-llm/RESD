...
from ..utils.checkpoint import CheckpointHandler, OrchestrationMode
from ..utils.dataset.dataset_utils import SFTTensorCollator
from ..utils.dataset.multiturn_sft_dataset import MultiTurnSFTDataset
from ..utils.device import auto_set_device, get_device_name
...
class SFTTrainer:
    ...
    def _build_engine(self):
        ...
        from ..workers.utils.losses import sft_loss
...
def create_sft_dataset(data_paths, data_config, tokenizer, processor, max_samples=-1):
    ...
    if data_config.custom_cls.get("path", None):
        from ..utils.import_utils import load_extern_type
