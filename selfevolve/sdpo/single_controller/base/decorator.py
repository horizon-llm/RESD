...
from ...protocol import DataProtoFuture, _padding_size_key
from ...utils.py_functional import DynamicEnum
from ...utils.tensordict_utils import chunk_tensordict, concat_tensordict, contiguous
from ...utils.transferqueue_utils import BatchMeta
...
def dispatch_nd_compute(dp_rank_mapping: list[int], dp_size, worker_group, *args, **kwargs):
    ...
    from ...single_controller.base.worker_group import WorkerGroup
    from ...utils.ray_utils import parallel_put
