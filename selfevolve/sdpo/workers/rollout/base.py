...
_ROLLOUT_REGISTRY = {
    ("vllm", "async"): ".vllm_rollout.vLLMAsyncRollout",
    ("sglang", "async"): ".sglang_rollout.sglang_rollout.ServerAdapter",
}
...
def get_rollout_class(rollout_name: str, mode: str = "async") -> type[BaseRollout]:
    ...
    rollout_module = importlib.import_module(module_name, package=__package__)
