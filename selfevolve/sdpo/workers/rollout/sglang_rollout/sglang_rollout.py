...
from ....workers.rollout.sglang_rollout.http_server_engine import AsyncHttpServerAdapter
from ....workers.rollout.sglang_rollout.utils import get_named_tensor_buckets
from ....workers.rollout.utils import is_valid_ipv6_address
...
class ServerAdapter(BaseRollout):
    ...
    async def update_weights(self, weights: Generator[tuple[str, torch.Tensor], None, None], **kwargs):
        ...
        if self.config.get("quantization", None) == "fp8":
            from ....utils.sglang.sglang_fp8_utils import quant_weights_by_name
