...
from ....third_party.vllm import VLLM_SLEEP_LEVEL, get_version
from ....utils.device import is_npu_available
from ....utils.distributed import initialize_global_process_group_ray
from ....utils.ray_utils import ray_noset_visible_devices
from ....utils.vllm import TensorLoRARequest, VLLMHijack, is_version_ge
from ....utils.vllm.vllm_fp8_utils import apply_vllm_fp8_patches, is_fp8_model, load_quanted_weights
from ....workers.config import HFModelConfig, RolloutConfig
from ....workers.rollout.base import BaseRollout
from ....workers.rollout.utils import get_free_port, is_valid_ipv6_address
from ....workers.rollout.vllm_rollout.utils import (
    VLLM_LORA_INT_ID,
    VLLM_LORA_NAME,
    VLLM_LORA_PATH,
...
class vLLMAsyncRollout(BaseRollout):
    ...
    async def update_weights(self, weights: Generator[tuple[str, torch.Tensor], None, None], **kwargs):
        ...
        if peft_config and base_sync_done:
            ...
            from ....utils.vllm.patch import patch_vllm_moe_model_weight_loader
