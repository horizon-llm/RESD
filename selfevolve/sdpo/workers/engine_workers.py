...
from ..utils.distributed import initialize_global_process_group_ray
from ..utils.flops_counter import FlopsCounter
from ..utils.memory_utils import aggressive_empty_cache
from ..utils.metric.utils import Metric
from ..utils.profiler import DistProfiler, DistProfilerExtension, ProfilerConfig, log_gpu_memory_usage
from ..utils.py_functional import append_to_dict
from ..utils.tensordict_utils import maybe_fix_3d_position_ids
from ..utils.torch_functional import allgather_dict_into_dict
from ..workers.config import ActorConfig, HFModelConfig, RolloutConfig, TrainingWorkerConfig
from ..workers.rollout.base import BaseRollout, get_rollout_class
from ..workers.utils.losses import ppo_loss
...
class TrainingWorker(Worker, DistProfilerExtension):
    ...
    def __init__(self, config: TrainingWorkerConfig):
        ...
        from ..workers.engine import BaseEngine, EngineRegistry
