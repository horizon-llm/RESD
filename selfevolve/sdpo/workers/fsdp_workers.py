...
from ..models.transformers.monkey_patch import apply_monkey_patch
...
from ..utils.activation_offload import enable_activation_offloading
...
from ..utils.model import compute_position_id_with_mask, convert_weight_keys
from ..utils.profiler import DistProfiler, DistProfilerExtension, ProfilerConfig, log_gpu_memory_usage, simple_timer
...
from ..workers.config import FSDPCriticConfig, FSDPEngineConfig, HFModelConfig, RolloutConfig
from ..workers.config.optimizer import build_optimizer
from ..workers.rollout import get_rollout_class
from ..workers.sharding_manager.fsdp_ulysses import FSDPUlyssesShardingManager
...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
    ...
    def _build_model_optimizer(
        ...
        from ..utils.model import get_generation_config, print_model_size, update_model_config
        ...
        if role == "actor" and optim_config is not None:
            from ..utils.torch_functional import get_constant_schedule_with_warmup, get_cosine_schedule_with_warmup
    ...
    def init_model(self):
        ...
        from ..workers.actor.dp_actor import TrustRegionTeacher
    ...
    def save_checkpoint(self, local_path, hdfs_path=None, global_step=0, max_ckpt_to_keep=None):
        from ..utils.logger import log_with_rank
...
class CriticWorker(Worker, DistProfilerExtension):
    ...
    def _build_critic_model_optimizer(self, config):
        ...
        from ..utils.model import load_valuehead_model, print_model_size
        from ..utils.torch_dtypes import PrecisionType
...
class RewardModelWorker(Worker, DistProfilerExtension):
    ...
    def _forward_micro_batch(self, micro_batch):
        from ..utils.attention_utils import index_first_axis, pad_input, rearrange, unpad_input
