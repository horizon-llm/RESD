...
from ....utils.dataset.dataset_utils import DatasetPadMode
from ....utils.debug import log_gpu_memory_usage
from ....utils.device import get_device_id, get_device_name
from ....utils.megatron.pipeline_parallel import make_batch_generator
from ....utils.megatron.tensor_parallel import vocab_parallel_entropy, vocab_parallel_log_probs_from_logits
...
from ....utils.model import extract_multi_modal_inputs, load_mcore_dist_weights
from ....workers.config import HFModelConfig, McoreEngineConfig, McoreOptimizerConfig
...
class MegatronEngine(BaseEngine):
    ...
    def _build_tf_config(self):
        from ....utils.megatron_utils import mapping_string_to_attn_backend
    ...
    def _build_optimizer(self):
        from ....utils.megatron.optimizer import get_megatron_optimizer, init_megatron_optim_config
    ...
    def _build_lr_scheduler(self):
        from ....utils.megatron.optimizer import get_megatron_optimizer_param_scheduler
...
class MegatronEngineWithLMHead(MegatronEngine):
    ...
    def forward_step(self, batch_iter: Iterator[TensorDict], model, postprocess_micro_batch_func):
        ...
        from ....models.mcore import get_mcore_forward_no_padding_fn
