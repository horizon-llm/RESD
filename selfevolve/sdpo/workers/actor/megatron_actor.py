...
from ...trainer.ppo.core_algos import agg_loss, get_policy_loss_fn, kl_penalty
from ...utils.device import get_device_id, get_torch_device
from ...utils.megatron.pipeline_parallel import make_batch_generator
from ...utils.megatron.router_replay_patch import RouterReplay, RouterReplayAction
from ...utils.megatron.router_replay_utils import (
    RouterReplayHelper,
...
from ...utils.megatron_utils import get_model_config, unwrap_model
from ...utils.profiler import GPUMemoryLogger
from ...utils.profiler.profile import Profiler
from ...utils.py_functional import append_to_dict
from ...utils.seqlen_balancing import get_reverse_idx, rearrange_micro_batches
from ...utils.torch_functional import broadcast_dict_tensor
...
class MegatronPPOActor(BasePPOActor):
    def __init__(
        ...
        if self.use_fused_kernels and not getattr(self.config, "overlap_moe_expert_parallel_comm", False):
            ...
            from ...models.mcore.model_forward_fused import patch_fused_forward
    ...
    def forward_backward_batch(
        ...
        def loss_func(output, data, meta_info):
            ...
            if not forward_only:
                ...
                if loss_mode != "bypass_mode" and rollout_log_prob is not None:
                    ...
                    from ...trainer.ppo.rollout_corr_helper import compute_rollout_corr_metrics_from_logprobs
        ...
        def forward_step(batch_iter, model, return_schedule_plan: bool = False):
            ...
            if return_schedule_plan:
                ...
                from ...models.mcore.model_forward_1f1b_overlap import gptmodel_forward_1f1b_overlap
            ...
            if "multi_modal_inputs" in batch:
                from ...utils.model import extract_multi_modal_inputs
            ...
            from ...models.mcore import get_mcore_forward_fn, get_mcore_forward_fused_fn
