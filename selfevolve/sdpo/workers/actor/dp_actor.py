...
from ...trainer.ppo.core_algos import agg_loss, compute_self_distillation_loss, get_policy_loss_fn, kl_penalty
...
from ...utils.fsdp_utils import FSDPModule, fsdp2_clip_grad_norm_
...
from ...utils.ulysses import gather_outputs_and_unpad, slice_input_tensor, ulysses_pad, ulysses_pad_and_slice_inputs
from ...workers.actor import BasePPOActor
from ...workers.config import ActorConfig
    ...
    def _forward_micro_batch(
        ...
        if self.use_prefix_grouper:
            ...
            if can_use_pg and "response_mask" in micro_batch and "uid" in micro_batch:
                from ...trainer.ppo.prefix_grouper_utils import forward_micro_batch_with_prefix_grouper
        ...
        with torch.autocast(device_type=self.device_name, dtype=self.param_dtype):
            ...
            if self.use_remove_padding:
                ...
                if "image_bound" in multi_modal_inputs:
                    from ...utils.dataset.vision_utils import process_multi_modal_inputs_for_minicpmo
