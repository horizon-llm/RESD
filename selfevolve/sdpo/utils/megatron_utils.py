...
from ..utils.megatron import tensor_parallel as tp_utils
from ..utils.device import get_device_id, get_device_name, get_torch_device
from ..utils.fs import local_mkdir_safe
from ..utils.model import normalize_model_name
...
def make_megatron_module(
    ...
    if bridge is not None:
        if provider is None:
            from ..models.mcore.mbridge import freeze_moe_router, make_value_model

            value_model_hook = make_value_model
        else:
            from ..models.mcore.bridge import freeze_moe_router, make_value_model
        ...
        if provider is not None:
            ...
            if peft_cls is not None:
                from ..utils.megatron_peft_utils import load_adapter_checkpoint, print_adapter_info
        ...
        def megatron_model_provider(pre_process, post_process, vp_stage=None):
            from ..models.mcore import init_mcore_model
