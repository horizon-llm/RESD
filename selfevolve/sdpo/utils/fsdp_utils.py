...
from ..utils.model import check_exclude_modules, check_target_modules
...
def fsdp2_load_full_state_dict(model: torch.nn.Module, full_state: dict, device_mesh=None, cpu_offload=None):
    ...
    if version.parse(torch.__version__) >= version.parse("2.7.0"):
        ...
        from ..third_party.torch.distributed.checkpoint.state_dict import StateDictOptions, set_model_state_dict
