...
python selfevolve/sdpo_fewshot/data/format/bouncingsim.py \
    --data_source bouncingsim/bouncingsim-ROTOBJ-basic \
    --num_data ${NUM_DATA} \
    --data_source_suffix "rotobj_basic"

train_path=selfevolve/sdpo_fewshot/datasets/bouncingsim_rotobj_basic/train_${NUM_DATA}.parquet
val_path=selfevolve/sdpo_fewshot/datasets/bouncingsim_rotobj_basic/test.parquet

########################### Quick Config ###########################

TASK=bouncingsim_rotobj_basic
export TASK
...
project_name='sdpo_stream_bouncingsim_rotobj_basic'
