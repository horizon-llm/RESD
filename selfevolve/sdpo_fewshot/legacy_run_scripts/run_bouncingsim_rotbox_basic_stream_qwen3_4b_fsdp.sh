...
python selfevolve/sdpo_fewshot/data/format/bouncingsim.py \
    --data_source bouncingsim/bouncingsim-ROTBOX-basic \
    --num_data ${NUM_DATA} \
    --data_source_suffix "rotbox_basic"

train_path=selfevolve/sdpo_fewshot/datasets/bouncingsim_rotbox_basic/train_${NUM_DATA}.parquet
val_path=selfevolve/sdpo_fewshot/datasets/bouncingsim_rotbox_basic/test.parquet

########################### Quick Config ###########################

TASK=bouncingsim_rotbox_basic
export TASK
...
project_name='sdpo_stream_bouncingsim_rotbox_basic'
