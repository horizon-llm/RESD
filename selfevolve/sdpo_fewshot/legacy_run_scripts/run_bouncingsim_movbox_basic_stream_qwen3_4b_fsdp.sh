...
python selfevolve/sdpo_fewshot/data/format/bouncingsim.py \
    --data_source bouncingsim/bouncingsim-MOVBOX-basic \
    --num_data ${NUM_DATA} \
    --data_source_suffix "movbox_basic"

train_path=selfevolve/sdpo_fewshot/datasets/bouncingsim_movbox_basic/train_${NUM_DATA}.parquet
val_path=selfevolve/sdpo_fewshot/datasets/bouncingsim_movbox_basic/test.parquet

########################### Quick Config ###########################

TASK=bouncingsim_movbox_basic
export TASK
...
project_name='sdpo_stream_bouncingsim_movbox_basic'
