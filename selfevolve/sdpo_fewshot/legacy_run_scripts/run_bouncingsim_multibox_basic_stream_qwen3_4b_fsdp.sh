...
python selfevolve/sdpo_fewshot/data/format/bouncingsim.py \
    --data_source bouncingsim/bouncingsim-MULTIBOX-basic \
    --num_data ${NUM_DATA} \
    --data_source_suffix "multibox_basic"

train_path=selfevolve/sdpo_fewshot/datasets/bouncingsim_multibox_basic/train_${NUM_DATA}.parquet
val_path=selfevolve/sdpo_fewshot/datasets/bouncingsim_multibox_basic/test.parquet

########################### Quick Config ###########################

TASK=bouncingsim_multibox_basic
export TASK
...
project_name='sdpo_stream_bouncingsim_multibox_basic'
