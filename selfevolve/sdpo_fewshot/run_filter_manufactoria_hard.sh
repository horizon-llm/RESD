...
DATA=${DATA:-"selfevolve/sdpo_fewshot/datasets/manufactoria/train_${NUM_DATA}.parquet"}
OUTPUT=${OUTPUT:-"selfevolve/sdpo_fewshot/datasets/manufactoria/train_hard.parquet"}
K=${K:-8}
TP=${TP:-4}
...
GPU_MEM=${GPU_MEM:-0.9}
RESULTS=${RESULTS:-"selfevolve/sdpo_fewshot/datasets/manufactoria/eval_results.jsonl"}
