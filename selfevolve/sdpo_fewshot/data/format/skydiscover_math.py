...
def get_datasource():
    path_str='./selfevolve/sdpo_fewshot/feedback/skydiscover_math'
...
BASE_DIR = './selfevolve/sdpo_fewshot/feedback/skydiscover_math'
CONFIG_PATH = BASE_DIR + '/{data_type}/config.yaml'
INITIAL_PATH = BASE_DIR + '/{data_type}/initial_program.py'
OUT_DIR='./selfevolve/sdpo_fewshot/datasets/skydiscover_math/train.parquet'
