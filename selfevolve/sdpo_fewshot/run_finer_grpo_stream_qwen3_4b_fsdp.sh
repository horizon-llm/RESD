...
reward_function=${reward_function:-"compute_score_count"} # which reward function to use; must be a function defined in selfevolve/sdpo_fewshot/feedback/finer.py

project_name='grpo_stream_finer'
