...
Usage (sudoku / sokoban - reasoning_gym dispatcher):
    python -m selfevolve.sdpo_fewshot.filter_hard_examples \
        ...
        --data selfevolve/sdpo_fewshot/datasets/sudoku/train.parquet \
        --output selfevolve/sdpo_fewshot/datasets/sudoku/train_hard.parquet \
        --k 8 --enable_thinking

Usage (manufactoria - dedicated scorer):
    python -m selfevolve.sdpo_fewshot.filter_hard_examples \
        --model Qwen/Qwen3-4B-Thinking-2507 \
        --data selfevolve/sdpo_fewshot/datasets/manufactoria/train_-1.parquet \
        --output selfevolve/sdpo_fewshot/datasets/manufactoria/train_hard.parquet \
        --reward_function_path selfevolve/sdpo_fewshot/feedback/manufactoria.py \
        --k 8 --enable_thinking
"""
